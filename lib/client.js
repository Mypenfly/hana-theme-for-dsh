window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    var CORAL = {
      ...
      "--dsw-alias-label-secondary": "#405062",
      "--dsw-alias-label-tertiary": "#657079",
      "--dsw-alias-label-caption": "#798185",
      "--dsw-alias-label-dimmed": "#8F9392",
      "--dsw-alias-label-primary-dimmed": "#405062",
      ...
      "--dsw-alias-markdown-placeholder": "#8F9392",
      "--dsw-alias-scrollbar-bg-l1": "rgba(0,0,0,0)",
      "--dsw-alias-scrollbar-bg-l2": "rgba(0,0,0,0)",
