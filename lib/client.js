window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    var CORAL = {
      ...
      "--dsw-alias-bg-layer-2": "#F9EEE2",
      "--dsw-alias-bg-layer-3": "#F2ECE4",
      "--dsw-alias-bg-overlay": "#FFFEFA",
      ...
      "--dsw-alias-label-secondary": "#3E5061",
      "--dsw-alias-label-tertiary": "#636F78",
      "--dsw-alias-label-caption": "#768084",
      "--dsw-alias-label-dimmed": "#8C9190",
      "--dsw-alias-label-primary-dimmed": "#3E5061",
      ...
      "--dsw-alias-button-elevated-fill": "#FFFEFA",
      "--dsw-alias-button-floating-fill": "#FFFEFA",
      ...
      "--dsw-alias-button-tool-bar-fill": "#FFFEFA",
      ...
      "--dsw-specific-menu": "#FFFEFA",
      "--dsw-specific-tip": "#F5ECDE",
      ...
      "--dsw-alias-markdown-inline-code": "#F2EDE6",
      "--dsw-alias-markdown-code-block": "#F4ECE4",
      ...
      "--dsw-alias-markdown-placeholder": "#8C9190",
      "--dsw-alias-scrollbar-bg-l1": "rgba(0,0,0,0)",
      "--dsw-alias-scrollbar-bg-l2": "rgba(0,0,0,0)",
    ...
    var SHIKI_CORAL = {
      ...
      "--shiki-background": "#F4ECE4",
      "--shiki-token-constant": "#1560A3",
      "--shiki-token-string": "#247934",
      "--shiki-token-string-expression": "#21692F",
      "--shiki-token-comment": "#656C74",
      "--shiki-token-keyword": "#A92251",
      "--shiki-token-parameter": "#B14409",
      "--shiki-token-function": "#4824B4",
      "--shiki-token-punctuation": "#383D42",
      "--shiki-token-link": "#135694"
    };
