...
const FIELD_DEFAULTS = {
  ...
  grainOpacity: '32',
  shape: 'soft',
  // 'accent' (the reference's own focus colour) or 'native' (leave the
  // harness's). Default ON because the item is a fix, not a preference: the
  // reference has ONE ring colour for the whole app and DSH has five, one of
  // which measures 2.45:1 in 珊瑚 -- below the 3:1 a non-text indicator needs.
  focus: 'accent',
